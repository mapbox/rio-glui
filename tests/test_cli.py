...
def test_glui_valid(launch, TileServer):
    ...
    TileServer.return_value.get_template_url.return_value = 'http://127.0.0.1:8080/index.html'
...
def test_glui_valid_playground(launch, TileServer):
    """Should work as expected."""
    TileServer.return_value.get_playround_url.return_value = 'http://127.0.0.1:8080/playground.html'
    TileServer.return_value.start.return_value = True
